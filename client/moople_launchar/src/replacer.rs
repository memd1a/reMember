...
mod tests {
    ...
    fn replacer() {
        ...
        let patches = vec![
            Patch::Replace { needle: &[1], replace: &[11] },
            Patch::Replace { needle: &[0], replace: &[11] },
            Patch::Replace { needle: &[4,5], replace: &[15,14] },
            Patch::Replace { needle: &[7,8], replace: &[17, 18] },
        ];
        ...
        assert_eq!(w.as_slice(), &[11,2,3,15,14,6,17,18]);
    }
}